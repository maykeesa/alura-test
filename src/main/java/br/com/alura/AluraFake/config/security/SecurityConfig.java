package br.com.alura.AluraFake.config.security;

import br.com.alura.AluraFake.config.security.jwt.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/course/*/publish").hasAuthority("INSTRUCTOR")
